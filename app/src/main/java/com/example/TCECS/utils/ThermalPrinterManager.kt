...
class ThermalPrinterManager(private val context: Context) {
    ...
    fun formatPrintData(member: Member): String {
        ...
        builder.append("TRANSPORT CORPORATION EMPLOYEES\n")
        builder.append("CO-OP THRIFT & CREDIT SOCIETY LIMITED X-367\n")
        ...
        builder.append("------------------------------------------------\n")
        builder.append("\u001B\u0045\u0001") // Bold On
        builder.append("GENERAL BODY MEETING\n")
        builder.append("\u001B\u0045\u0000") // Bold Off
        builder.append("Date: 27/01/2026 at 4:00 P.M\n")
        builder.append("Venue: No 10, Rathna Nagar, Teynampet, Chennai - 18\n")
        builder.append("------------------------------------------------\n")
        ...
        builder.append("\u001B\u0045\u0000") // Bold Off
        builder.append(" Corporation : ${member.station ?: ""}\n")
        ...
        // --- 4. FOOTER: INSURANCE, NEFT & AC NO ---
        builder.append("\u001B\u0045\u0001")
        builder.append(formatKeyValue("Demand Adjust", "Rs. ${member.insurance ?: 0}"))
